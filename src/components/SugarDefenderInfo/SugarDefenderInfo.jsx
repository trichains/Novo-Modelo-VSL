      ...
      <Container>
        <div className="w-full flex flex-col items-center text-center bg-slate-200 p-8 md:p-12 rounded-3xl shadow-sm">
          ...
          <div className="w-full md:max-w-3xl flex flex-col items-center text-sm md:text-base gap-4 p-2 text-stone-800">
            ...
            <p>
              FloraSlim has helped thousands safely assist their blood sugar and
              drop pounds... Quickly, easily and from home.
            </p>
            <p>
            ...
            <p>
              Every bottle of FloraSlim comes with a full 60-day guarantee. You
              can try it out and see its improving effects on your blood sugar
              with absolutely no-risk whatsoever!
            </p>
          </div>
          <div className="flex flex-col items-center justify-center mt-4 gap-4">
            <p className="font-semibold italic text-md md:text-lg">
              Tom Green Creator, FloraSlim
            </p>
            <img
