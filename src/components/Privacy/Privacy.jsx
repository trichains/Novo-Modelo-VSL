// Criar a estrutura da política de privacidade
// Puxar o container
// Puxar a navbar
...
const Privacy = () => {
    return (
        <div>
            ...
            <h1>
                PRIVACY POLICY for
                <a href="https://floraslimofficial.com/">FloraSlim's Sales Page</a>
            </h1>
            <p>
                At
                <a href="https://floraslimofficial.com/">FloraSlim's Sales Page</a> we are committed
                to safeguarding and preserving the privacy of our visitors.
            </p>

            <p>
                This Privacy Policy explains what happens to any personal data that you
                provide to us, or that we collect from you whilst you visit our site. We
                do update this Policy from time to time so please do review this Policy
                regularly.
            </p>
            ...
            <p>
                Information about your use of our site including details of your visits
                such as pages viewed and the resources that you access. Such information
                includes traffic data, location data and other communication data.
                Information provided voluntarily by you. For example, when you register
                for information or make a purchase. Information that you provide when
                you communicate with us by any means.
            </p>
            ...
            <p>
                ...
                computer fin order to assist us in improving our website.
            </p>
            ...
            <p>
                We use the information that we collect from you to provide our services
                to you. If you purchase a product, an order confirmation will be sent
                from sac@sevencom.org to the email address provided at purchase. In
                addition to this we may use the information for one or more of the
                following purposes:
            </p>

            <p>
                To provide information to you that you request from us relating to our
                products or services. To provide information to you relating to other
                products that may be of interest to you. Such additional information
                will only be provided where you have consented to receive such
                information.
            </p>

            <p>
                To inform you of any changes to our website, services or goods and
                products. If you have previously purchased goods or services from us we
                may provide to you details of similar goods or services, or other goods
            ...
            <p>
                ...
                to this transfer, storing or processing. We do our utmost to ensure that
            ...
            <p>
                In the event that we sell any or all of our business to the buyer. Where
                we are legally required by law to disclose your personal information. To
            ...
            <p>
                ...
                this Privacy Policy at sac@sevencom.org
            </p>
